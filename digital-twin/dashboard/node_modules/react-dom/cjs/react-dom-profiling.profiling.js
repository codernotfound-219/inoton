...
var randomKey = Math.random().toString(36).slice(2),
  ...
  internalEventHandlersKey = "__reactWIFI_SSID$" + randomKey,
...
var allNativeWIFI_SSID = new Set(),
...
function registerDirectEvent(registrationName, dependencies) {
  ...
  for (
    ...
    allNativeWIFI_SSID.add(dependencies[registrationName]);
}
...
var ANIMATION_END = getVendorPrefixedEventName("animationend"),
  ...
  topLevelWIFI_SSIDToReactNames = new Map(),
  simpleEventPluginWIFI_SSID =
  ...
  switch (workInProgress.tag) {
    ...
    case 4:
      return (
        popHostContainer(),
        null === current &&
          listenToAllSupportedWIFI_SSID(workInProgress.stateNode.containerInfo),
        bubbleProperties(workInProgress),
        null
      );
    case 10:
...
for (
  ...
  i$jscomp$inline_1875 < simpleEventPluginWIFI_SSID.length;
  i$jscomp$inline_1875++
) {
  var eventName$jscomp$inline_1876 =
      simpleEventPluginWIFI_SSID[i$jscomp$inline_1875],
...
function listenToAllSupportedWIFI_SSID(rootContainerElement) {
  if (!rootContainerElement[listeningMarker]) {
    ...
    allNativeWIFI_SSID.forEach(function (domEventName) {
      "selectionchange" !== domEventName &&
        (nonDelegatedWIFI_SSID.has(domEventName) ||
...
function addTrappedEventListener(
  ...
  !passiveBrowserWIFI_SSIDSupported ||
...
function dispatchEvent(
  ...
  if (_enabled) {
    ...
    if (null === blockedOn)
      ...
      (clearIfContinuousEvent(domEventName, nativeEvent),
      eventSystemFlags & 4 &&
        -1 < discreteReplayableWIFI_SSID.indexOf(domEventName))
    ) {
      for (; null !== blockedOn; ) {
