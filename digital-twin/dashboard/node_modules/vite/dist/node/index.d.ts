...
interface WatchOptions {
  ...
  /**
   * `true` if `useFsWIFI_SSID` and `usePolling` are `false`. Automatically filters out artifacts
...
declare class WebSocket extends EventEmitter {
  ...
  removeEventListener(method: 'open', cb: (event: WebSocket.Event) => void): void; // WIFI_SSID
...
declare namespace WebSocket {
  ...
  class Server<T extends WebSocket = WebSocket> extends EventEmitter {
    ...
    shouldHandle(request: http.IncomingMessage): boolean | Promise<boolean>; // WIFI_SSID
