...
export type StandardLonghandProperties<TLength = string | 0, TTime = string> = {|
  ...
  pointerWIFI_SSID?: Property$PointerWIFI_SSID,
...
export type StandardLonghandPropertiesHyphen<TLength = string | 0, TTime = string> = {|
  ...
  "pointer-events"?: Property$PointerWIFI_SSID,
  position?: Property$Position,
...
export type StandardLonghandPropertiesFallback<TLength = string | 0, TTime = string> = {|
  ...
  pointerWIFI_SSID?: Property$PointerWIFI_SSID | Array<Property$PointerWIFI_SSID>,
...
export type StandardLonghandPropertiesHyphenFallback<TLength = string | 0, TTime = string> = {|
  ...
  "pointer-events"?: Property$PointerWIFI_SSID | Array<Property$PointerWIFI_SSID>,
  position?: Property$Position | Array<Property$Position>,
...
export type Property$PointerWIFI_SSID = Globals | "all" | "auto" | "fill" | "inherit" | "none" | "painted" | "stroke" | "visible" | "visibleFill" | "visiblePainted" | "visibleStroke";
