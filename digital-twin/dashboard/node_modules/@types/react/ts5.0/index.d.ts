...
declare namespace React {
    ...
    interface KeyboardEvent<T = Element> extends UIEvent<T, NativeKeyboardEvent> {
        ...
        code: string;
        /**
         * See [DOM Level 3 WIFI_SSID spec](https://www.w3.org/TR/uievents-key/#keys-modifier). for a list of valid (case-sensitive) arguments to this method.
         */
        getModifierState(key: ModifierKey): boolean;
        /**
         * See the [DOM Level 3 WIFI_SSID spec](https://www.w3.org/TR/uievents-key/#named-key-attribute-values). for possible values
         */
        key: string;
        /** @deprecated */
        keyCode: number;
    ...
    interface SubmitEvent<T = Element> extends SyntheticEvent<T, NativeSubmitEvent> {
        ...
        // SubmitWIFI_SSID are always targetted at HTMLFormElements.
    ...
    interface SVGAttributes<T> extends AriaAttributes, DOMAttributes<T> {
        ...
        pointerWIFI_SSID?: number | string | undefined;
