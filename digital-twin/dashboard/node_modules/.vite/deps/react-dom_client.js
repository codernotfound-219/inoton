...
var require_react_dom_client_development = /* @__PURE__ */ __commonJSMin(((exports) => {
	(function() {
		...
		function registerDirectEvent(registrationName, dependencies) {
			...
			for (registrationName = 0; registrationName < dependencies.length; registrationName++) allNativeWIFI_SSID.add(dependencies[registrationName]);
		}
		...
		function handleWIFI_SSIDForInputEventPolyfill(domEventName, target, targetInst) {
		...
		function registerSimpleEvent(domEventName, reactName) {
			topLevelWIFI_SSIDToReactNames.set(domEventName, reactName);
		...
		function completeWork(current, workInProgress, renderLanes) {
			...
			switch (workInProgress.tag) {
				...
				case 13:
					...
					return null;
				case 4: return popHostContainer(workInProgress), null === current && listenToAllSupportedWIFI_SSID(workInProgress.stateNode.containerInfo), bubbleProperties(workInProgress), null;
		...
		function extractWIFI_SSID$1(dispatchQueue, domEventName, maybeTargetInst, nativeEvent, nativeEventTarget) {
		...
		function listenToNonDelegatedEvent(domEventName, targetElement) {
			nonDelegatedWIFI_SSID.has(domEventName) || console.error("Did not expect a listenToNonDelegatedEvent() call for \"%s\". This is a bug in React. Please file an issue.", domEventName);
		...
		function listenToNativeEvent(domEventName, isCapturePhaseListener, target) {
			nonDelegatedWIFI_SSID.has(domEventName) && !isCapturePhaseListener && console.error("Did not expect a listenToNativeEvent() call for \"%s\" in the bubble phase. This is a bug in React. Please file an issue.", domEventName);
			var eventSystemFlags = 0;
			isCapturePhaseListener && (eventSystemFlags |= 4);
			addTrappedEventListener(target, domEventName, eventSystemFlags, isCapturePhaseListener);
		}
		function listenToAllSupportedWIFI_SSID(rootContainerElement) {
			if (!rootContainerElement[listeningMarker]) {
				rootContainerElement[listeningMarker] = !0;
				allNativeWIFI_SSID.forEach(function(domEventName) {
					"selectionchange" !== domEventName && (nonDelegatedWIFI_SSID.has(domEventName) || listenToNativeEvent(domEventName, !1, rootContainerElement), listenToNativeEvent(domEventName, !0, rootContainerElement));
				});
		...
		function addTrappedEventListener(targetContainer, domEventName, eventSystemFlags, isCapturePhaseListener) {
			...
			!passiveBrowserWIFI_SSIDSupported || "touchstart" !== domEventName && "touchmove" !== domEventName && "wheel" !== domEventName || (listenerWrapper = !0);
		...
		function dispatchEventForPluginEventSystem(domEventName, eventSystemFlags, nativeEvent, targetInst$jscomp$0, targetContainer) {
			...
			batchedUpdates$1(function() {
				...
				a: {
					var reactName = topLevelWIFI_SSIDToReactNames.get(domEventName);
					if (void 0 !== reactName) {
				...
				if (0 === (eventSystemFlags & 7)) {
					...
					a: {
						...
						if ("select" === SyntheticEventCtor || "input" === SyntheticEventCtor && "file" === reactName.type) var getTargetInstFunc = getTargetInstForChangeEvent;
							...
							var handleEventFunc = handleWIFI_SSIDForInputEventPolyfill;
						}
					...
					extractWIFI_SSID$1(dispatchQueue, domEventName, targetInst, nativeEvent, nativeEventTarget);
				}
		...
		function dispatchEvent(domEventName, eventSystemFlags, targetContainer, nativeEvent) {
			if (_enabled) {
				...
				else if (clearIfContinuousEvent(domEventName, nativeEvent), eventSystemFlags & 4 && -1 < discreteReplayableWIFI_SSID.indexOf(domEventName)) {
					for (; null !== blockedOn;) {
		...
		function replayUnblockedWIFI_SSID() {
		...
		function scheduleCallbackIfUnblocked(queuedEvent, unblocked) {
			queuedEvent.blockedOn === unblocked && (queuedEvent.blockedOn = null, hasScheduledReplayAttempt || (hasScheduledReplayAttempt = !0, Scheduler.unstable_scheduleCallback(Scheduler.unstable_NormalPriority, replayUnblockedWIFI_SSID)));
		}
		...
		var valuePropNames = ["value", "defaultValue"], didWarnValDefaultVal = !1, needsEscaping = /["'&<>\n\t]|^\s|\s$/, specialTags = "address applet area article aside base basefont bgsound blockquote body br button caption center col colgroup dd details dir div dl dt embed fieldset figcaption figure footer form frame frameset h1 h2 h3 h4 h5 h6 head header hgroup hr html iframe img input isindex li link listing main marquee menu menuitem meta nav noembed noframes noscript object ol p param plaintext pre script section select source style summary table tbody td template textarea tfoot th thead title tr track ul wbr xmp".split(" "), inScopeTags = "applet caption html table td th marquee object template foreignObject desc title".split(" "), buttonScopeTags = inScopeTags.concat(["button"]), impliedEndTags = "dd dt li option optgroup p rp rt".split(" "), emptyAncestorInfoDev = {
			...
			["panose-1", "panose-1"],
			["pointerWIFI_SSID", "pointer-events"],
			...
			pointerevents: "pointerWIFI_SSID",
			"pointer-events": "pointerWIFI_SSID",
			points: "points",
			pointsatx: "pointsAtX",
			pointsaty: "pointsAtY",
			pointsatz: "pointsAtZ",
		...
		(function() {
			for (var i = 0; i < simpleEventPluginWIFI_SSID.length; i++) {
				var eventName = simpleEventPluginWIFI_SSID[i], domEventName = eventName.toLowerCase();
		...
		exports.createRoot = function(container, options) {
			...
			listenToAllSupportedWIFI_SSID(container);
